...
\begin{frame}
  ...
  \begin{definitions}
    ...
    \textbf{Linia plażowa} (\textit{beach line}) - krzywa utworzona przez punty równoległe od linii zamiatającej i najbliższe z punktów już przetworzonych. Składa się z łuków parabolicznych.
...
\begin{frame}
  \frametitle{Triangulacja Delaunaya - zwiazek z diagramem Voronoi}
  \begin{definition}
