...
\begin{frame}
  ...
  \begin{definition}
    ...
    Zazwyczaj wymagane jest, aby krawędzie i wierzchołki trójkątów pokrywały się w całości z krawędziami i wierzchołkami innych trójkątów.
...
\begin{frame}
  ...
  \begin{small}
    \begin{proof}
      ...
      Ponieważ diagram Voronoi posiada nieskończone ściany, \textbf{dodajemy do niego sztuczny wierzchołek} i łączymy go z wszystkimi nieskończonymi krawędziami, tworząc nowy graf planarny. Z \textbf{wzoru Eulera dla grafów planarnych} mamy $(V + 1) - E + N = 2$ ($V + 1$, ponieważ dodaliśmy nowy wierzchołek).
      \pause
