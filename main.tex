...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item \textbf{Linia plażowa} (\textit{beach line}) - krzywa utworzona przez łuki parabol, reprezentująca granicę między obszarami już przetworzonymi a tymi, które jeszcze nie zostały przetworzone.
    \item \textbf{Zdarzenia} - punkty, w których linia zamiatająca napotyka punkty lub miejsca, w których zaniknie łuk paraboliczny na linii plażowej.
  \end{itemize}
  \begin{center}
    \includegraphics[scale=0.5]{sweep-beach-line.png}
  \end{center}
\end{frame}
