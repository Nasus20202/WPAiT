...
\subsection{Triangulacja w geometrii}
\begin{frame}
...
\subsection{Triangulacja w teorii grafów}
\begin{frame}
...
\subsection{Diagramy Voronoi - algorytmy tworzenia}
\begin{frame}
      ...
      \begin{tikzpicture}[scale=0.5]
        ...
        \foreach \x in {0,1,...,19} {
          \foreach \y in {0,1,...,9} {
            ...
            \fill[red!50] (\x+0.02, \y+0.02) rectangle (\x+0.98, \y+0.98);
            \else\ifdim \minDist pt = \distBlue pt
            \fill[blue!50] (\x+0.02, \y+0.02) rectangle (\x+0.98, \y+0.98);
            \else\ifdim \minDist pt = \distGreen pt
            \fill[green!50] (\x+0.02, \y+0.02) rectangle (\x+0.98, \y+0.98);
            \else\ifdim \minDist pt = \distYellow pt
            \fill[yellow!50] (\x+0.02, \y+0.02) rectangle (\x+0.98, \y+0.98);
            \else
            \fill[purple!50] (\x+0.02, \y+0.02) rectangle (\x+0.98, \y+0.98);
            \fi\fi\fi\fi
          }
        }
